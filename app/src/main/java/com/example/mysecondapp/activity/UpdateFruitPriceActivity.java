...
public class UpdateFruitPriceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_fruit_price);
        ...
        RecyclerView recyclerView = findViewById(R.id.rvFruitUpdate);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(new CustomAdapterUpdatePrice(fruits));
